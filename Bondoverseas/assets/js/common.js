...
$(function () {
  ...
  $(window).on("scroll", function () {
    ...
    600 < $(window).scrollTop() ? $("[data-gotop]").fadeIn(300) : $("[data-gotop]").fadeOut(300);
  }).trigger('scroll'), $("[data-gotop]").on("click", function () {
    $("body, html").animate({
      scrollTop: 0
    }, 400);
  }), $(".faqQuestion").on("click", function (o) {
    var t = $(this).attr("href");
    $(o.target).is(".active") ? a() : (a(), $(this).addClass("active"), $(".faqCont " + t).slideDown(300)), o.preventDefault();
  });
});