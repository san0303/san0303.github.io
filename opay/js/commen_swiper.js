...
$(document).ready(function () {
  ...
  if (msie > 0 || !!navigator.userAgent.match(/Trident.*rv\:11\./)) {
    ...
    /*首頁swiper*/
    IndexSwiper = new Swiper(".index_swiper", {
      slidesPerView: 3,
      spaceBetween: 50,
      freeMode: true,
      autoplay: {
...
window.onload = function () {
  ...
  /*模式三切換*/
  $(".bs104 .lockright .lock_ic").click(function () {
    $(".bs104 .lockright").css("height", "0");
    $(".bs104 .lockleft").css("height", "auto");
    galleryTop1_2.slideTo(1, 0, false);
  });
  /*模式三切換*/
  $(".bs104 .lockleft .lock_ic").click(function () {
    $(".bs104 .lockright").css("height", "auto");
    $(".bs104 .lockleft").css("height", "0");
    galleryTop1_1.slideTo(1, 0, false);
  });
